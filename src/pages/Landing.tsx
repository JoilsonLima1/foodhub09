...
export default function Landing() {
  ...
  // Then apply the public branding colors from super admin settings
  useEffect(() => {
    resetThemeToDefault();
  }, []);
  
  // Apply public theme colors from super admin settings
  usePublicTheme();
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HeroSection 
        ...
        heroTitlePart1={landingLayout.hero_title_part1}
        heroTitlePart2={landingLayout.hero_title_part2}
        heroTitlePart3={landingLayout.hero_title_part3}
        heroTitlePart4={landingLayout.hero_title_part4}
        ...
        heroTitleParts={landingLayout.hero_title_parts}
      />
